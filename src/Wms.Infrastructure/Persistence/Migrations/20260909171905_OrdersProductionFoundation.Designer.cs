...
namespace Wms.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260909171905_OrdersProductionFoundation")]
    partial class OrdersProductionFoundation
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.HasSequence("pickup_code_sequence", "shipping");
            ...
            modelBuilder.Entity("Wms.Domain.Operations.OrderDocument", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("SalesOrderId", "Kind")
                        .IsUnique();

                    b.ToTable("order_documents", "operations");
                });

            modelBuilder.Entity("Wms.Domain.Operations.OrderEvent", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("order_events", "operations");
                });

            modelBuilder.Entity("Wms.Domain.Operations.OrderLine", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");

                    b.Property<bool>("CustomCompleted")
                        .HasColumnType("boolean");
                    ...
                    b.ToTable("order_lines", "operations", t =>
                        {
                            t.HasCheckConstraint("ck_line_quantities", "\"Quantity\" > 0 AND \"Reserved\" >= 0 AND \"Reserved\" <= \"Quantity\"");
                        });
                });

            modelBuilder.Entity("Wms.Domain.Operations.SalesOrder", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("orders", "operations");
                });

            modelBuilder.Entity("Wms.Domain.Operations.StockBalance", b =>
                {
                    b.Property<Guid>("VariantId")
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("stock_balances", "operations", t =>
                        {
                            t.HasCheckConstraint("ck_stock_quantities", "\"OnHand\" >= 0 AND \"Reserved\" >= 0 AND \"Reserved\" <= \"OnHand\"");
                        });
                });

            modelBuilder.Entity("Wms.Domain.Operations.StockMovement", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("OperationId", "VariantId")
                        .IsUnique();

                    b.ToTable("stock_movements", "operations");
                });

            modelBuilder.Entity("Wms.Domain.Shipping.Carrier", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("NormalizedName")
                        .IsUnique()
                        .HasDatabaseName("ux_carriers_normalized_name");

                    b.HasIndex("TaxId")
                        .IsUnique()
                        .HasDatabaseName("ux_carriers_tax_id")
                        .HasFilter("\"TaxId\" IS NOT NULL");

                    b.ToTable("carriers", "shipping");
                });

            modelBuilder.Entity("Wms.Domain.Shipping.PickupRequest", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("Code")
                        .IsUnique()
                        .HasDatabaseName("ux_pickup_requests_code");

                    b.HasIndex("PublicAccessToken")
                        .IsUnique()
                        .HasDatabaseName("ux_pickup_requests_public_token");

                    b.HasIndex("Status", "ScheduledAtUtc")
                        .HasDatabaseName("ix_pickup_requests_status_schedule");

                    b.ToTable("pickup_requests", "shipping");
                });
            ...
            modelBuilder.Entity("Wms.Infrastructure.Authorization.Permission", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            ...
                            Code = "carriers.read",
                            CreatedAtUtc = new DateTimeOffset(new DateTime(2026, 8, 26, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)),
                            Description = "Permite consultar transportadoras.",
                            IsActive = true,
                            IsSystem = true,
                            Module = "Shipping",
                        ...
                        new
                        {
                            ...
                            CreatedAtUtc = new DateTimeOffset(new DateTime(2026, 8, 26, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)),
                            Description = "Permite cadastrar e alterar transportadoras.",
                            IsActive = true,
                            IsSystem = true,
                            Module = "Shipping",
                        ...
                        new
                        {
                            ...
                            Code = "dispatch.read",
                            CreatedAtUtc = new DateTimeOffset(new DateTime(2026, 8, 26, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)),
                            Description = "Permite consultar coletas e expedições.",
                            IsActive = true,
                            IsSystem = true,
                            Module = "Shipping",
                            Name = "Visualizar expedições"
                        },
                        new
                        {
                            ...
                            CreatedAtUtc = new DateTimeOffset(new DateTime(2026, 8, 26, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)),
                            Description = "Permite criar e administrar solicitações de coleta.",
                            IsActive = true,
                            IsSystem = true,
                            Module = "Shipping",
                            Name = "Gerenciar expedições"
                        },
                        new
                        {
                            Id = new Guid("10000000-0000-0000-0000-000000000032"),
                            Code = "dispatch.readiness.update",
                            CreatedAtUtc = new DateTimeOffset(new DateTime(2026, 8, 26, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)),
                            Description = "Permite informar preparação, prontidão e coleta.",
                            IsActive = true,
                            IsSystem = true,
                            Module = "Shipping",
                            Name = "Atualizar prontidão"
                        });
                });
            ...
            modelBuilder.Entity("Wms.Domain.Operations.OrderDocument", b =>
                {
                    b.HasOne("Wms.Domain.Operations.SalesOrder", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Wms.Domain.Operations.OrderLine", b =>
                {
                    ...
                    b.HasOne("Wms.Domain.Catalog.ProductVariant", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Wms.Domain.Shipping.PickupRequest", b =>
                {
                    b.HasOne("Wms.Domain.Shipping.Carrier", "Carrier")
